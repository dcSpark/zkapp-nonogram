/**
 * This file specifies how to run the `OldNonogramZkApp` smart contract locally using the `Mina.LocalBlockchain()` method.
...
async function run() {
  ...
  await OldNonogramZkApp.compile();
