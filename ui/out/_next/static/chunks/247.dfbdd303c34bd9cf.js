"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[247,106,647,561],{
...
function checkRowCircuit(row, noColor, streaks) {
    ...
    for (let j = 0; j < row.length; j++) {
        ...
        // matchCurrentColor = false
        {
            ...
            const adjustedIndex = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Circuit["if"] */ .dx["if"](streakIndex.lt(0), (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(0), streakIndex);
