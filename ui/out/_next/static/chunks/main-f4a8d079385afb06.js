    ...
    _initialize = _async_to_generator(function() {
        ...
        return _tsGenerator(this, function(_state) {
            ...
            if (initialData.scriptLoader) {
                initScriptLoader = (__webpack_require__(3573).initScriptLoader);
...
function AppContainer(param) {
    ...
    return /*#__PURE__*/ _react.default.createElement(Container, {
        ...
        value: {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/zkapp-nonogram/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":true}
    }, children)))))));
}
...
function renderError(renderErrorProps) {
    ...
    return pageLoader.loadPage("/_error").then(function(param) {
        ...
        return (lastAppProps == null ? void 0 : lastAppProps.Component) === ErrorComponent ? Promise.resolve().then(function() {
            return /*#__PURE__*/ _interopRequireWildcard(__webpack_require__(67));
        }).then(function(errorModule) {
            return Promise.resolve().then(function() {
                return /*#__PURE__*/ _interopRequireWildcard(__webpack_require__(4297));
...
var _default = function(onPerfEntry) {
    ...
    isRegistered = true;
    var attributions = undefined;
    var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for(var _iterator = WEB_VITALS[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            var webVital = _step.value;
            try {
                var mod = void 0;
                if (false) {}
                if (!mod) {
...
function Script(props) {
    ...
    var ref = (0, _react).useContext(_headManagerContext.HeadManagerContext), updateScripts = ref.updateScripts, scripts = ref.scripts, getIsSsr = ref.getIsSsr, appDir = ref.appDir, nonce = ref.nonce;
    /**
   * - First mount:
...
var ParamsContext = (0, _react).createContext(null);
exports.ParamsContext = ParamsContext;
var LayoutSegmentsContext = (0, _react).createContext(null);
...
function PathnameContextProviderAdapter(_param) {
    var children = _param.children, router = _param.router, props = _object_without_properties_loose(_param, [
        "children",
        "router"
    ]);
    ...
    var value = (0, _react).useMemo(function() {
        ...
        var url = new URL(router.asPath, "http://f");
        return url.pathname;
    }, [
        router.asPath,
        router.isFallback,
...
var Router = /*#__PURE__*/ function() {
    function Router(pathname1, query1, as1, param) {
        ...
        this.basePath = "/zkapp-nonogram" || 0;
   ...
   */ key: "replace",
        ...
        },
        {
            ...
            value: function getRouteInfo(param) {
                ...
                var _this = this;
                return _async_to_generator(function() {
                    var route, ref, ref4, ref5, ref6, handleCancelled, existingInfo, cachedRouteInfo, isBackground, fetchNextDataParams, data, _tmp, resolvedRoute, pages, routeInfo, _tmp1, isValidElementType, wasBailedPrefetch, shouldFetchData, ref1, props, cacheKey, err;
                    return _tsGenerator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                            ...
                            case 4:
                                ...
                                if (!((data == null ? void 0 : (ref5 = data.effect) == null ? void 0 : ref5.type) === "rewrite")) return [
                                    3,
                                    6
                                ];
                            ...
                            case 8:
                                routeInfo = _tmp1;
                                if (false) {}
                                wasBailedPrefetch = data == null ? void 0 : (ref6 = data.response) == null ? void 0 : ref6.headers.get("x-middleware-skip");
                                        ...
                                        return _tsGenerator(this, function(_state) {
                                            switch(_state.label){
                                                case 0:
                                                    ...
                                                    if (!((data == null ? void 0 : data.json) && !wasBailedPrefetch)) return [
                                                        3,
                                                        1
                                                    ];
                                                    _tmp = data;
